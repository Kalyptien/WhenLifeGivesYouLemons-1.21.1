...
public class IndustrialBrewingBarrelScreen extends AbstractContainerScreen<IndustrialBrewingBarrelMenu> {
    private static final ResourceLocation GUI_TEXTURE =
            ResourceLocation.fromNamespaceAndPath(WhenLifeGivesYouLemonsMod.MOD_ID,"textures/gui/industrial_brewing_barrel_gui.png");
    ...
    public IndustrialBrewingBarrelScreen(IndustrialBrewingBarrelMenu menu, Inventory playerInventory, Component title) {
