...
import com.kalyptien.wlgyl.block.entity.IndustrialBrewingBarrelBlockEntity;
...
public class IndustrialBrewingBarrelMenu extends AbstractContainerMenu {
    public final IndustrialBrewingBarrelBlockEntity blockEntity;
    ...
    public IndustrialBrewingBarrelMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.INDUSTRIAL_BREWING_BARREL_MENU.get(), pContainerId);
        this.blockEntity = ((IndustrialBrewingBarrelBlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.INDUSTRIAL_BREWING_BARREL.get());
    }
