...
public class ModModelProvider extends ModelProvider {
    ...
    public static ModelBuilder growLeaveBlock(BlockModelProvider provider, String name, ResourceLocation texture0, ResourceLocation texture1) {
