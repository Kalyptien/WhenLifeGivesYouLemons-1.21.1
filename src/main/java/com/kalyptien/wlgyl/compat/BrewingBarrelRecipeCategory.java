...
public class BrewingBarrelRecipeCategory  implements IRecipeCategory<BrewingBarrelRecipe> {
    ...
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(WhenLifeGivesYouLemonsMod.MOD_ID,
            "textures/gui/brewing_barrel_jei_gui.png");
    ...
    public BrewingBarrelRecipeCategory(IGuiHelper helper) {
        this.background = helper.createDrawable(TEXTURE,20 ,13, 134, 62);
